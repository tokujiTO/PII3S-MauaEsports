...
export default function Teams() {
  return (
    <div className="font-body relative flex h-full w-full flex-col items-center justify-center bg-gradient-to-l from-cyan-300 via-purple-500 to-pink-500 py-8">
