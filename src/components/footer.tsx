      ...
      <div className="z-10 flex h-3/4 flex-col items-start justify-evenly gap-6 md:flex-row lg:gap-16 lg:px-16 lg:pt-24">
        ...
        <div className="neon-text-blue flex w-full flex-col md:w-1/3">
          <div className="flex flex-col items-center gap-2 text-3xl md:items-end">
            <p
              className={`duration-300 hover:scale-125 hover:cursor-pointer ${isSelected('/') ? 'neon-text-pink' : ''}`}
              onClick={() => {
                navigate('/');
                scrollTo(0, 0);
              }}
            ...
            <p
              className={`duration-300 hover:scale-125 hover:cursor-pointer ${isSelected('/membros') ? 'neon-text-pink' : ''}`}
              onClick={() => {
                navigate('/membros');
                scrollTo(0, 0);
              }}
            ...
            <p
              className={`duration-300 hover:scale-125 hover:cursor-pointer ${isSelected('/campeonatos') ? 'neon-text-pink' : ''}`}
              onClick={() => {
