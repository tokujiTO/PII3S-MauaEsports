...
export default function OurMission({ section }: OurMissionProps) {
  return (
    <div className="bg-darkBlue z-20 flex min-h-screen flex-col items-center justify-evenly overflow-x-hidden font-sans text-white lg:flex-row lg:pt-20">
