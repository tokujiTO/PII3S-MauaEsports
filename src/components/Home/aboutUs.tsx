...
export default function AboutUs() {
  return (
    <div className="bg-darkBlue neon-box-duo z-20 flex min-h-screen flex-col items-center justify-evenly overflow-x-hidden rounded-t-4xl pt-20 font-sans text-white md:flex-row md:rounded-t-[10rem]">
