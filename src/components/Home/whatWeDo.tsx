...
export default function WhatWeDo({ section }: WhatWeDoProps) {
  return (
    <div className="bg-darkBlue z-20 flex min-h-screen flex-col items-center justify-evenly overflow-x-hidden font-sans text-white xl:flex-row-reverse xl:pt-20">
      <div className="flex w-full flex-col items-center justify-center p-4 xl:w-1/2 xl:pr-20 2xl:pr-36">
        <AnimatedElement
          duration={400}
          delay={500}
          direction="top"
      ...
      >
        <img
          src={section?.image || './src/assets/logoBW.png'}
